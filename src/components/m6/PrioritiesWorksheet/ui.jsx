...
/**
 * Priorities Worksheet — shared presentational primitives.
 *
 ...
 * stays in copy.js. The lock affordance always pairs the icon with a text label
 * ("Private") so meaning is never carried by colour alone.
 */
...
// Small inline gold-tinted button used for chips and "Add".
