...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body style={{ margin: 0, backgroundColor: "#FAF8F2", fontFamily: "Source Sans Pro, sans-serif" }}>
        <ClerkProvider signInUrl="/login" signUpUrl="/signup" signInFallbackRedirectUrl="/dashboard" signUpFallbackRedirectUrl="/dashboard">
          ...
          >
            <a href="/" style={{ color: "#C8A96E", fontFamily: "Playfair Display, serif", fontSize: "1.4rem", textDecoration: "none", fontWeight: 700 }}>ClearPath</a>
